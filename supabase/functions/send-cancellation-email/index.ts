...
function buildHtml(opts: {
  ...
  const depositEuros = (deposit_amount / 100).toFixed(0)
              ...
              <table cellpadding="0" cellspacing="0" style="display:inline-table;">
                <tr>
                  ...
                  <td style="vertical-align:middle;">
                    <span style="font-family:'Manrope',Arial,sans-serif;font-size:22px;font-weight:800;color:#D8552E;letter-spacing:-0.5px;">Una Mesa</span>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="background:#FFFFFF;border-radius:16px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,0.06);">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="background:#D8552E;height:6px;font-size:0;line-height:0;">&nbsp;</td>
                </tr>
              </table>
                ...
                <tr>
                  <td style="padding:40px 48px 0;">
                    ...
                    <h1 style="margin:0 0 12px;font-size:28px;font-weight:800;color:#121212;line-height:1.2;letter-spacing:-0.5px;">
                      Tu reserva ha sido<br>cancelada, ${firstName}.
                    </h1>
                    <p style="margin:0 0 32px;font-size:15px;color:#555;line-height:1.6;">
                      Hemos cancelado tu mesa en <strong style="color:#121212;">${restaurant_name}</strong>. Aquí tienes el resumen.
                    </p>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0">
                                  <tr>
                                    ...
                                    <td width="50%">
                                      ...
                                      <p style="margin:0;font-size:16px;font-weight:700;color:#D8552E;">${depositEuros}€ <span style="font-size:12px;font-weight:500;color:#999;">· a reembolsar</span></p>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                      ...
                      <tr>
                        <td style="padding:14px 18px;">
                          <p style="margin:0;font-size:13px;color:#555;line-height:1.5;">
                            Tu depósito de <strong style="color:#121212;">${depositEuros}€</strong> será reembolsado en <strong style="color:#121212;">5-10 días hábiles</strong> en el método de pago original.
                          </p>
                        </td>
                      </tr>
                    </table>
          ...
          <tr>
            <td align="center" style="padding:28px 0 0;">
              ...
              <p style="margin:6px 0 0;font-size:11px;color:#CCC;">
                Has recibido este email porque cancelaste una reserva en Una Mesa.
              </p>
            </td>
          </tr>
