...
Deno.serve(async (req) => {
  ...
  if (!reservation) return new Response(html(t.invalidTitle, t.invalidNotExist, false, t.lang), { headers: { 'Content-Type': 'text/html' }, status: 404 })
  if (reservation.status === 'cancelled') {
    return new Response(html(t.alreadyCancelledTitle, t.alreadyCancelledBody, false, t.lang), { headers: { 'Content-Type': 'text/html' }, status: 409 })
  }
