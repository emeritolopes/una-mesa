...
const DT_T = {
  es: {
    ...
    depositPre: 'Depósito de ', depositAmountFn: (r) => (window.UM_CURRENCY_SYMBOL?window.UM_CURRENCY_SYMBOL(r.currency):'€')+(r.deposit||10)+'/persona', depositPost: ' — se descuenta del total.',
  ...
  en: {
    ...
    depositPre: 'Deposit of ', depositAmountFn: (r) => (window.UM_CURRENCY_SYMBOL?window.UM_CURRENCY_SYMBOL(r.currency):'£')+(r.deposit||10)+'/person', depositPost: ' — deducted from the total.',
  ...
  return React.createElement('div', { className:'view' },
    React.createElement('div', { className:'wrap' },
      ...
      React.createElement('div', { className:'gallery' },
        React.createElement(Photo,{ cz:r.cz, glyph:r.glyph,          slotId:'um-'+r.id+'-g0', className:'g-main', photoUrl:(r.photo_urls||[])[0] }),
        React.createElement(Photo,{ cz:{from:r.cz.to,to:r.cz.from},  glyph:r.glyph, slotId:'um-'+r.id+'-g1', photoUrl:(r.photo_urls||[])[1] }),
        React.createElement(Photo,{ cz:r.cz,                          glyph:'wine',  slotId:'um-'+r.id+'-g2', photoUrl:(r.photo_urls||[])[2] }),
        React.createElement(Photo,{ cz:{from:r.cz.to,to:r.cz.from},  glyph:'pot',   slotId:'um-'+r.id+'-g3', photoUrl:(r.photo_urls||[])[3] }),
        React.createElement(Photo,{ cz:r.cz,                          glyph:r.glyph, slotId:'um-'+r.id+'-g4', photoUrl:(r.photo_urls||[])[4] })
      ),
          ...
          React.createElement('div', { className:'det-bw' },
            ...
            React.createElement('div', { className:'det-bw-dep' },
              ...
              React.createElement('span',null,
                DT_T.depositPre, React.createElement('b',null,DT_T.depositAmountFn(r)),
                DT_T.depositPost
              )
            ),
