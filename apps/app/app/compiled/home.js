...
const UM_T = {
  es: {
    ...
    depositPre: 'Reserva con depósito reembolsable de ',
    depositAmountFn: r => (window.UM_CURRENCY_SYMBOL ? window.UM_CURRENCY_SYMBOL(r.currency) : '€') + (r.deposit || 10),
  ...
  en: {
    ...
    depositPre: 'Book with a refundable deposit of ',
    depositAmountFn: r => (window.UM_CURRENCY_SYMBOL ? window.UM_CURRENCY_SYMBOL(r.currency) : '£') + (r.deposit || 10),
