...
function App() {
  ...
  if (route.view==='home')
    ...
    screen = React.createElement(window.ResultsScreen, { key: geo?.lat || 'nogeo', query:route.query, openRest, favs, toggleFav, startBook, geoLabel: geo.label && geo.label !== 'tu ubicación actual' ? geo.label : 'Vigo', geo });
